...
public:
    ...
    void setupUi(QWidget *UserProFile)
    {
        ...
        verticalSpacer_5 = new QSpacerItem(20, 200, QSizePolicy::Policy::Minimum, QSizePolicy::Policy::Fixed);
    ...
    void retranslateUi(QWidget *UserProFile)
    {
        ...
        label_DIsplayUname->setText(QCoreApplication::translate("UserProFile", "TextLabel", nullptr));
