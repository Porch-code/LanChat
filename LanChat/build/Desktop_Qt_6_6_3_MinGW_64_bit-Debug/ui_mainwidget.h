...
public:
    ...
    void setupUi(QWidget *MainWidget)
    {
        ...
        verticalSpacer_3 = new QSpacerItem(20, 450, QSizePolicy::Policy::Minimum, QSizePolicy::Policy::Fixed);
        ...
        horizontalSpacer_3 = new QSpacerItem(600, 20, QSizePolicy::Policy::Fixed, QSizePolicy::Policy::Minimum);
        ...
        textBrowser = new QTextBrowser(verticalStackedWidgetPage1);
        ...
        horizontalSpacer_7 = new QSpacerItem(350, 20, QSizePolicy::Policy::Fixed, QSizePolicy::Policy::Minimum);
        ...
        verticalSpacer_5 = new QSpacerItem(20, 60, QSizePolicy::Policy::Minimum, QSizePolicy::Policy::Fixed);
        ...
        verticalSpacer_8 = new QSpacerItem(20, 100, QSizePolicy::Policy::Minimum, QSizePolicy::Policy::Fixed);
        ...
        widget = new QWidget(verticalStackedWidgetPage4);
        widget->setObjectName("widget");
        widget->setGeometry(QRect(200, 130, 202, 295));
        verticalLayout_7 = new QVBoxLayout(widget);
        verticalLayout_7->setObjectName("verticalLayout_7");
        verticalLayout_7->setContentsMargins(0, 0, 0, 0);
        label_home_ProFile = new QLabel(widget);
        ...
        label_home_text = new QLabel(widget);
        label_home_text->setObjectName("label_home_text");
        label_home_text->setAlignment(Qt::AlignmentFlag::AlignCenter);
    ...
    void retranslateUi(QWidget *MainWidget)
    {
        ...
        label_data_FriendName->setText(QCoreApplication::translate("MainWidget", "TextLabel", nullptr));
        label_data_FriendGender->setText(QCoreApplication::translate("MainWidget", "TextLabel", nullptr));
        label_data_FriendAge->setText(QCoreApplication::translate("MainWidget", "TextLabel", nullptr));
        label_data_FriendRegion->setText(QCoreApplication::translate("MainWidget", "TextLabel", nullptr));
